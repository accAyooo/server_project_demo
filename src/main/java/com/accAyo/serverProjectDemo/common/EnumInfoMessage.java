...
//    PAYED_MONEY_MAX("pay-16", "充值金额不得大于" + Constants.PAY_MAX_TOPUP_MONEY + "元", ""),
    ...
    private EnumInfoMessage(String value, String desc, String code) {
        this.value = value;
        this.desc = desc;
        this.code = code;
    }
    ...
    public static EnumInfoMessage getEnum(String type) {
        EnumInfoMessage[] status = EnumInfoMessage.values();
