package com.accAyo.serverProjectDemo.framework.util;
...
public class ResultFilter1<E> implements Serializable {

	private static final long serialVersionUID = -2199614767549628573L;
	...
	public ResultFilter1(int totalCount, int pageSize, int currentPage) {
	...
	public ResultFilter1(List list, int pageSize, int currentPage) {
		this(list, pageSize, currentPage, DEFAULT_NAVIGATOR_SIZE);
	}

    public ResultFilter1(List list, int pageSize, int currentPage, int navigatorSize) {
